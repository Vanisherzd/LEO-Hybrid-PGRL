...
\begin{itemize}
  ...
  \item An offline IQ-structure analysis of that capture (101 candidate bursts across 19 occupied frequency bins, $\approx$12\% time occupancy, structure score $\approx$0.845) consistent with sparse LR-FHSS-like RF energy, without payload decoding, CRC validation, or packet-delivery measurement.
\end{itemize}
