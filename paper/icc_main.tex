...
\begin{figure}[t]
    ...
    % (1) TLE/SGP4 data registry (database cylinder)
    \begin{scope}[shift={(0.35,2.25)}]
      \fill[blue!12] (-0.3,0.3) -- (-0.3,-0.3) arc (180:360:0.3 and 0.09) -- (0.3,0.3) arc (0:180:0.3 and 0.09);
      \draw[gray] (-0.3,0.3) -- (-0.3,-0.3) arc (180:360:0.3 and 0.09) -- (0.3,0.3);
      \draw[gray!60,line width=0.3pt] (-0.3,0.1)  arc (180:360:0.3 and 0.09);
      \draw[gray!60,line width=0.3pt] (-0.3,-0.1) arc (180:360:0.3 and 0.09);
      \draw[gray,fill=blue!18] (0,0.3) ellipse (0.3 and 0.09);
    \end{scope}
    \node[lbl,anchor=north,align=center] at (0.35,1.82) {TLE / SGP4\\states};
    ...
    \draw[ar] (0.72,2.2) -- (1.22,2.18);        % TLE -> NN
    ...
    \node[lbl, anchor=west, fill=gray!12, rounded corners, inner xsep=3pt, inner ysep=1.5pt] at (-0.3,1.25) {RF/hardware};
