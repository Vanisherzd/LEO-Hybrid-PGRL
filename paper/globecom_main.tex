...
\begin{figure}[t]
    ...
    \caption{System architecture: TLE source $\rightarrow$ SGP4 propagator $\rightarrow$ PGRL Bayesian corrector $\rightarrow$ uplink controller (guard-band, TX timing, Doppler pre-comp) $\rightarrow$ Semtech LR1121 TX / USRP B210 testbed.}
