...
def make_booktabs(data, col_fmt="lcccc"):
    ...
    lines = [
        "\\begin{table}[htbp]",
        "\\centering",
        f"\\caption{{\\label{{tab:main}}{data.get('caption', 'Results Summary')}}}",
    ...
    for row in rows:
        # Bold the 'Proposed' column (last column) for numeric rows where Proposed < Baseline
        # For text rows (Planned, N/A), don't bold
...
table3_tex = make_booktabs({
    "caption": "Uncertainty-Aware Guard-Band Policy",
